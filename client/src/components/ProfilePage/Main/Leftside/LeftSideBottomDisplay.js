      ...
      <div className="basicInfoMain">
        ...
        <div className="basicInfochild">
          ...
          <div className="currentlocation">
            <span>Country: </span><span>{data.locationCountry}</span>
            <span>City: </span><span>{data.locationCity}</span>
          </div>
        </div>
        <div className="basicInfochild">
          <p>Language:</p>
...
export default LeftSideBottomDisplay;